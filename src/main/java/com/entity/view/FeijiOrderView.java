...
public class FeijiOrderView extends FeijiOrderEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		/**
		* 订单类型的值
		*/
		private String feijiOrderValue;
	...
	public FeijiOrderView() {

	}

	public FeijiOrderView(FeijiOrderEntity feijiOrderEntity) {
		try {
			BeanUtils.copyProperties(this, feijiOrderEntity);
			...
			* 获取： 订单类型的值
			*/
			public String getFeijiOrderValue() {
				return feijiOrderValue;
			}
			/**
			* 设置： 订单类型的值
			*/
			public void setFeijiOrderValue(String feijiOrderValue) {
				this.feijiOrderValue = feijiOrderValue;
			}
