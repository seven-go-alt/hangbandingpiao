...
public class FeijiLiuyanView extends FeijiLiuyanEntity implements Serializable {
	...
	public FeijiLiuyanView() {

	}

	public FeijiLiuyanView(FeijiLiuyanEntity feijiLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, feijiLiuyanEntity);
