...
var centerMenu = [
    ...
    ,{
        name: '飞机收藏',
        url: '../feijiCollection/list.jsp'
    }
    ,{
        name: '飞机订单',
        url: '../feijiOrder/list.jsp'
    }
...
var adminurl =  "http://localhost:8080/hangbandingpiao/index.jsp";
