            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">飞机收藏展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                          ...
                          <div class="layui-inline" style="margin-bottom: 10px;">
                              ...
                              <div class="layui-input-inline">
                                  <input type="text" name="feijiName" id="feijiName" placeholder="航班号" autocomplete="off" class="layui-input">
                              </div>
                          </div>
                          ...
                          <div class="layui-inline" style="margin-bottom: 10px;">
                              ...
                              <div class="layui-input-inline">
                                  <select name="feijiTypes" id="feijiTypes" lay-filter="feijiTypes">
                                      <option value="">--请选择--</option>
                                      <option v-for="item in feijiTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
                                  </select>
                              </div>
                          </div>
                          ...
                          <div class="layui-inline" style="margin-bottom: 10px;">
                              ...
                              <div class="layui-input-inline">
                                  <input type="text" name="feijiStartAddress" id="feijiStartAddress" placeholder="始发站" autocomplete="off" class="layui-input">
                              </div>
                          </div>
                          ...
                          <div class="layui-inline" style="margin-bottom: 10px;">
                              ...
                              <div class="layui-input-inline">
                                  <input type="text" name="feijiEndAddress" id="feijiEndAddress" placeholder="目的地" autocomplete="off" class="layui-input">
                              </div>
                          </div>
                          ...
                          <div class="layui-inline" style="margin-bottom: 10px;">
                              ...
                              <div class="layui-input-inline">
                                  <input type="text" name="feijiNewMoneyStart" id="feijiNewMoneyStart"  lay-skin="double"   placeholder="票价开始" autocomplete="off" class="layui-input">
                              </div>
                          </div>
                          <div class="layui-inline" style="margin-bottom: 10px;">
                              <div class="layui-input-inline" style="margin-top: -5px">
                                  <input type="text" name="feijiNewMoneyEnd"   id="feijiNewMoneyEnd"    lay-skin="double|feijiNewMoneyEnd"   placeholder="票价结束" autocomplete="off" class="layui-input">
                              </div>
                          </div>
                        ...
                        <ul>
                            <li v-for="(item,index) in dataList" v-bind:key="index">
                                <div class="ng-prslist-doc">
                                    <div class="ng-prslist-img" @click="jump('../feiji/detail.jsp?id='+item.feijiId)">
                                        <a href="#" class="ng-prsliik">
                                          <span class="ng-prsliik-ki ng-prsliik-ki_1">
                                            <img class="swiper-item" :src="item.feijiPhoto?item.feijiPhoto.split(',')[0]:''" />
                                          </span>
                                    ...
                                    <div class="ng-prslist-tit" @click="jump('../feiji/detail.jsp?id='+item.feijiId)"><span>{{item.feijiName}}</span></div>
                                    <div class="ng-prslist-tit" v-if="item.feijiNewMoney"><span style="color: red;">{{item.feijiNewMoney}} RMB</span></div>
                                    <div class="ng-prslist-tit" ><span style="color: red;" @click="deleteFeijiCollection(item.id)">删除 {{item.feijiName}} 收藏</span></div>
                                </div>
                            </li>
                        </ul>
                    </div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 feijiCollectionContent 字段去除无用字符 如果字段长度大于60  就截取到60
            feijiCollectionContent: function(val) {
                if (val) {
        ...
        methods: {
            ...
            ,deleteFeijiCollection(id){
                layui.layer.confirm('确认要删除这个收藏吗？', {
                    btn : [ '确定', '取消' ]//按钮
                }, function(index) {
                    var paramArray = [];
                    paramArray.push(id);
                    layui.http.requestJson('feijiCollection/delete', 'post',paramArray, function (res) {
                        if (res.code == 0) {
                            layer.msg('删除成功', {
                                time: 2000,
                                icon: 6
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery', 'laydate'], function() {
        ...
        form.verify({
            ...
            ,feijiNewMoneyEnd: function(value, item){ //value：表单的值、item：表单的DOM对象
                var feijiNewMoneyStart = $("#feijiNewMoneyStart").val();
                if(feijiNewMoneyStart != null && feijiNewMoneyStart != "" && feijiNewMoneyStart != "null"){
                    var number = parseInt(value)- parseInt(feijiNewMoneyStart);
                    if(number<0){
                        return '票价的结束值不能小于开始值';
                    }
                }
            }
        ...
        function pageList() {
            ...
            if (jquery('#feijiName').val() != null && jquery('#feijiName').val() != "" && jquery('#feijiName').val() != "null" ) {
                param['feijiName'] = jquery('#feijiName').val();
            }
                     
            var feijiTypes = $("#feijiTypes").find("option:selected").val();
            if (feijiTypes != null && feijiTypes != "" && feijiTypes != "null") {
                            param['feijiTypes'] = feijiTypes;
                        }
                                                             
            if (jquery('#feijiStartAddress').val() != null && jquery('#feijiStartAddress').val() != "" && jquery('#feijiStartAddress').val() != "null" ) {
                param['feijiStartAddress'] = jquery('#feijiStartAddress').val();
            }
                     
            if (jquery('#feijiEndAddress').val() != null && jquery('#feijiEndAddress').val() != "" && jquery('#feijiEndAddress').val() != "null" ) {
                param['feijiEndAddress'] = jquery('#feijiEndAddress').val();
            }
                     
            if (jquery('#feijiNewMoneyStart').val() != null && jquery('#feijiNewMoneyStart').val() != "" && jquery('#feijiNewMoneyStart').val() != "null" ) {
                param['feijiNewMoneyStart'] = jquery('#feijiNewMoneyStart').val();
            }
            if (jquery('#feijiNewMoneyEnd').val() != null && jquery('#feijiNewMoneyEnd').val() != "" && jquery('#feijiNewMoneyEnd').val() != "null" ) {
                param['feijiNewMoneyEnd'] = jquery('#feijiNewMoneyEnd').val();
            }
                                                            
            // 当前表
                                                    // 获取列表数据
            http.request('feijiCollection/list', 'get', param, function(res) {
...
// 级联表的字典表
       ...
       // 飞机的查询
       function feijiTypesSelect() {
           http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=feiji_types", 'get', {}, function (res) {
               if(res.code == 0){
                   vue.feijiTypesList = res.data.list;
               }
           });
       }

       // 飞机类型的查询
       function feijiLeixingTypesSelect() {
           http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=feiji_leixing_types", 'get', {}, function (res) {
               if(res.code == 0){
                   vue.feijiLeixingTypesList = res.data.list;
               }
           });
       }
