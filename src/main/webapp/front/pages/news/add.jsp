        ...
        <form class="layui-form layui-form-pane" lay-filter="myForm">
            ...
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-block">
                    <input v-model="detail.newsName" type="text" name="newsName" id="newsName" placeholder="新闻名称" lay-verify="required" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
