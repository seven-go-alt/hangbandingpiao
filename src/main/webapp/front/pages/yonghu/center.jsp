		...
		<div id="app">
				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="yonghuName" id="yonghuName" lay-verify="required" placeholder="姓名" autocomplete="off" class="layui-input">
							</div>
						</div>
			...
			<div class="layui-form-item">
                <div class="layui-block">
                    ...
                    <div class="layui-input-block">
                        <input type="text" value="0" readonly name="newMoney" id="newMoney"  lay-verify="required|double"   placeholder="余额" autocomplete="off" class="layui-input" style="width: 500px">
