              ...
              <form class="layui-form login-form" lay-filter="register">
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">订票日期:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="feijiOrderTime" id="feijiOrderTime"  placeholder="订票日期"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        ...
                        <div class="layui-input-inline">
                            <select name="feijiOrderTypes" id="feijiOrderTypes" lay-filter="feijiOrderTypes" style="width: 600px;">
