            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">航班展示</span>
                    ...
                    <ul>
                        <li v-for="(item,index) in dataList" v-bind:key="index">
                            <div class="ng-prslist-doc">
                                <div class="ng-prslist-img" @click="jump('../feiji/detail.jsp?id='+item.id)">
                                ...
                                <div class="ng-prslist-tit" @click="jump('../feiji/detail.jsp?id='+item.id)"><span>{{item.feijiName}}</span></div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 feijiContent 字段去除无用字符 如果字段长度大于60  就截取到60
            feijiContent: function(val) {
                if (val) {
        ...
        function pageList() {
            ...
            if (jquery('#feijiNewMoneyEnd').val() != null && jquery('#feijiNewMoneyEnd').val() != "" && jquery('#feijiNewMoneyEnd').val() != "null" ) {
                param['feijiNewMoneyEnd'] = jquery('#feijiNewMoneyEnd').val();
                                    ...
                                    // 获取列表数据
            http.request('feiji/list', 'get', param, function(res) {
